...
public class IncomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Kategori pemasukan");
                ...
                .setPositiveButton("Simpan", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (addkategori.equals("")){
                            Toast.makeText(IncomeActivity.this, "null name category", Toast.LENGTH_SHORT).show();
                        }else{
                            saveToServer();
                        }
    ...
    private void saveToServer() {
        ...
        call.enqueue(new Callback<Value>() {
            ...
            public void onFailure(Call<Value> call, Throwable t) {
                progress.dismiss();
                Toast.makeText(IncomeActivity.this, "Jaringan error"+t, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void loadDataCategory(){
        ...
        call.enqueue(new Callback<ValueCategory>() {
            ...
            public void onResponse(Call<ValueCategory> call, Response<ValueCategory> response) {
                //Toast.makeText(IncomeActivity.this, ""+response.body().getValue(), Toast.LENGTH_SHORT).show();
                ...
                rvIncome.setLayoutManager(new LinearLayoutManager(IncomeActivity.this));
                ListAdapterKategory adapterKategory = new ListAdapterKategory(IncomeActivity.this,results,resultString,1);
                rvIncome.setAdapter(adapterKategory);
            }

            @Override
            public void onFailure(Call<ValueCategory> call, Throwable t) {
                Toast.makeText(IncomeActivity.this, "jaringan error", Toast.LENGTH_SHORT).show();
            }
        });
    }
